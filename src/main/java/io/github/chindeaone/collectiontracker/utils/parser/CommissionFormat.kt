...
object CommissionFormat {
    ...
    val COMMISSIONS = listOf(
        ...
        CommissionType("Scrap Collector", Area.GLACITE_TUNNELS) { formatLine(it) },
        CommissionType("Onyx Gemstone Collector", Area.GLACITE_TUNNELS) { formatLine(it) },
        CommissionType("Aquamarine Gemstone Collector", Area.GLACITE_TUNNELS) { formatLine(it) },
        CommissionType("Peridot Gemstone Collector", Area.GLACITE_TUNNELS) { formatLine(it) },
        CommissionType("Citrine Gemstone Collector", Area.GLACITE_TUNNELS) { formatLine(it) },
        CommissionType("Glacite Collector", Area.GLACITE_TUNNELS) { formatLine(it) },
