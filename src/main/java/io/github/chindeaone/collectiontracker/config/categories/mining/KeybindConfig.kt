...
class KeybindConfig {
    ...
    var commission1: Int = InputConstants.KEY_1
    ...
    var commission2: Int = InputConstants.KEY_2
    ...
    var commission3: Int = InputConstants.KEY_3
    ...
    var commission4: Int = InputConstants.KEY_4
}
